...
def	grafica2(i=8,b="input2.dat",size=3.):
	...
	xmn = -size/2.
	xmx = size/2.
	h,bx,by = histogram2d(x,y,bins=arange(xmn,xmx,0.01))	
	h=h/N
	return h,bx,by
...
def	campo_vettoriale(i=8,size=3.):
	...
	f=hfx**2+hfy**2
	quiver(by[:-1]+0.1,bx[:-1],hfy,hfx,f,scale=20)
#	quiver(by,bx,hfy,hfx,f,scale=20)
...
def	modulo_forza():
	...
	print("simulated mean of force module"+str(mean(modulo)))
